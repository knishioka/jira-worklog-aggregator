...
from worklog_aggregator.jira_connector import worklog_to_dict, extract_issue_worklogs, worklog_updated_issue_keys
...
def test_worklog_updated_issue_keys(jira_issue, mocker):
    ...
    assert worklog_updated_issue_keys("2020-03-01", "2020-03-31") == ["KEY-1"]
...
def test_worklog_to_dict(jira_worklog):
    expected_dict = {"spent_hours": 6.0, "created": "2020-04-01", "updated": "2020-04-01", "user": "user1"}
